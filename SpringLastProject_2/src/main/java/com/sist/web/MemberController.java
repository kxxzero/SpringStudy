...
public class MemberController {
	...
	/*
	 * @GetMapping("member/logout.do") public String member_logout(HttpSession
	 ...
	 * if(cookies[i].getName().equals("userId")) { cookies[i].setPath("/");
	 * cookies[i].setMaxAge(0); response.addCookie(cookies[i]); break; } } } return
