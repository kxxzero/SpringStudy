...
public class ReserveRestController {
  ...
  @GetMapping(value="reserve/reserve_ok.do", produces="text/plain;charset=UTF-8")
  ...
  @GetMapping(value="reserve/reserve_cancel.do", produces="text/plain;charset=UTF-8")
  ...
  public String reserve_admin() throws Exception {
  	List<ReserveVO> list=rService.reserveAdminPageData(userId);
  	ObjectMapper mapper=new ObjectMapper();
  	String json=mapper.writeValueAsString(list);
  ...
  public String reserve_ok(int no) {
