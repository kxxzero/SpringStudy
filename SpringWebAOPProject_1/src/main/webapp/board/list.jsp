	...
	<div class="container">
		<div class="col-sm-9">
			...
			<table class="table">
				...
				<c:forEach var="vo" items="${list}">
					<tr class="danger">
						...
						<td width="55%" class="text-center"><a href="detail.do?no=${vo.no}">${vo.subject}</a></td>
			...
			<table class="table">
				<tr>
					<td>
						<input type="checkbox" value="name" name="fd">이름
						<input type="checkbox" value="subject" name="fd">제목
						<input type="checkbox" value="content" name="fd">내용
						<input type="text" class="input-sm" name="ss">내용
